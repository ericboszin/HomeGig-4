class ApplicationController < ActionController::Base
    ...
    protected
        ...
        def configure_permitted_parameters
            devise_parameter_sanitizer.permit(:sign_up) { |u| u.permit(:name,:notification, :email, :password, :password_confirmation, :first_name, :last_name, :birthday, :aboutme, :skill, :role, :country, :phone, :admin)}
